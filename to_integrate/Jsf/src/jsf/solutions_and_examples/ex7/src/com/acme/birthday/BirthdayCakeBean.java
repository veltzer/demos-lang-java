package jsf.solutions_and_examples.ex7.src.com.acme.birthday;
...
public class BirthdayCakeBean {
	...
	public void setCurLocale(ActionEvent event) {
		UICommand curCommand = (UICommand) event.getComponent();
