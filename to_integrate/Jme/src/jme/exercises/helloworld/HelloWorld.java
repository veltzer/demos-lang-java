...
public class HelloWorld extends MIDlet {
	...
	protected void pauseApp() {
		...
		// Normally the Midlet would release any shared resources here and pause
		// execution.
	}
	...
	protected void startApp() {
		...
		System.out
				.println("MIDlet-Version: " + getAppProperty("MIDlet-Version"));
		System.out.println("MicroEdition-Configuration: "
				+ getAppProperty("MicroEdition-Configuration"));
		System.out.println("MicroEdition-Profile: "
				+ getAppProperty("MicroEdition-Profile"));
		System.out.println(
				"MIDlet-Jar-Size: " + getAppProperty("MIDlet-Jar-Size"));
		System.out
				.println("MIDlet-Jar-URL: " + getAppProperty("MIDlet-Jar-URL"));
		...
		System.out.println("-------------------------");
		System.out.println("Midlet display number of colors: "
		...
		// Normally the Midlet would allocate any shared resources here and
		// begin execution.
	}
}
