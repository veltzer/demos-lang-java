...
public abstract class Test {
	...
	public static void main(String[] args) {
		 ...
		 * "Customer1 name:" +customer1.getName()+" id:"
		 * +customer1.getAccount().getId()+ " balance:"
		 * +customer1.getAccount().getBalance()); System.out.println(
		 * "Customer2 name:" +customer2.getName()+" id:"
		 * +customer2.getAccount().getId()+ " balance:"
		 * +customer2.getAccount().getBalance()); System.out.println(
		 * "Customer3 name:" +customer3.getName()+" id:"
