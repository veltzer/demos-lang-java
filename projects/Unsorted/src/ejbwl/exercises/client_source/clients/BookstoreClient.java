...
public class BookstoreClient {
	...
	public static void main(String[] args) {
		...
		// view all books - here you should get a list of all the books in the store and print it:


		// Add customers - here you add customers to the store:


		// view all customers - here you should get a list of all the customers of the store and print it:
