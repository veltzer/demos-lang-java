...
public abstract class AutoRegistryTemplate {
	 ...
	 * instantiated, instantiate the class defined by the DefaultTo annotation
	 * on the interface
	 */
	...
	/*
	 * private static <T> T getFirstNotNull(Builder<T>... builders) { for
	 * (Builder<T> builder: builders) { T temp = builder.build(); if (temp !=
	 * null) return temp; } return null; }
	 */
}
