...
public class PersonBean {
	private String name;
	private String[] availableNames = {"Ran","Ron","Ronald","Randolf","Rafael","Romeo"};
	...
	public void completeName(FacesContext ctx, String prefix,CompletionResult completionResult) {
